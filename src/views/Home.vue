      ...
      <el-col :span="8" style="padding-right: 10px;">
        <el-card class="box-card">
          ...
          <div class="login-info">
            <p>上次登入的时间:<span>2022-1-2</span></p>
            <p>上次登入的地点:<span>桂林</span></p>
          </div>
        </el-card>
        <el-card class="box-card" style="margin-top: 20px; height: 460px;">
          <el-table :data="tableData" style="width: 100%;">
            ...
            <el-table-column v-for="(value, index) in tableLable" :key="value" :prop="index" :label="value" />
          </el-table>
        </el-card>
      </el-col>
  ...
  mounted() {
    getData().then(
      ({ data }) => {
        ...
        echarts1Option.xAxis = xAxixData
        echarts1Option.legend = xAxixData
